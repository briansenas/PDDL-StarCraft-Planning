(define (problem CosteTemporal)
    (:domain ejer8)
    (:objects
        VCE1 VCE2 VCE3 Marine1 Marine2 Soldado1 - Unidades
        CentroDeMando1 Extractor1 Barracon1 - Edificios
    ...
    (:init
        ...
        (= (coste plan) 0 )
        (= (costeMinimo esperado) 484)
        ;;(= (costeMinimo esperado) 483) ;;Empty at 1927 seconds

        ;; Coste Temporal
        (= (costeConstruir Barracon) 50)
        (= (costeConstruir Extractor) 20)

        (= (costeEntidad VCE) 10)
        (= (costeEntidad Marines) 20)
        (= (costeEntidad Soldados) 30)

        (= (costeNavegar VCE) 20)
        (= (costeNavegar Marines) 4)
        (= (costeNavegar Soldados) 2)
        ;; Posiciones
        ...
        ;; Cantidad
        (= (comprar Barracon Mineral) 30)
        (= (comprar Barracon Gas) 10)
        ...
        (generadoEn Marines Barracon)
        (generadoEn Soldados Barracon)
